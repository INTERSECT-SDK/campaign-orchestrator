...
from ...api.v1.endpoints.orchestrator.models.campaign import Campaign  # noqa: TC001
from ...api.v1.endpoints.orchestrator.models.campaign_state import (  # noqa: TC001
    CampaignState,
)
...
_require_pymongo = require_pymongo
_require_psycopg = require_psycopg
...
class CampaignRepository(Protocol):
    ...
    def create_campaign(
        self, campaign_id: UUID, campaign: Campaign, state: CampaignState
    ) -> None: ...
