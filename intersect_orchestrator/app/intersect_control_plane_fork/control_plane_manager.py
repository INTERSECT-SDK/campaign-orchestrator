"""
The control plane manager is inspired by the version in the INTERSECT-SDK, but has a few differences:

- There is no need to interact with a discovery service. We will directly connect to message brokers.
- Instead of publishing or subscribing to targeted channels, we want to subscribe to every channel.

This microservice should be considered to have "root" permissions in INTERSECT.
"""
