...
async def start_campaign(
    request: Request,
    _campaign: Annotated[Campaign, Body(media_type='application/json')],  # noqa: ARG001
...
async def stop_campaign(
    request: Request,
    _camapign_uuid: Annotated[IntersectCampaignId, Body(media_type='application/json')],  # noqa: ARG001
    api_key: Annotated[str, Security(api_key_header)],
) -> str:
...
async def campaign_events(
    ...
    async def event_publisher() -> typing.AsyncGenerator[str, None]:
